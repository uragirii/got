...
func TestObject(t *testing.T) {
	...
	t.Run("hashes and reads the file correctly", func(t *testing.T) {
		...
		if obj.RawString() != TEST_STR {
			t.Errorf("expected raw string to be %s but got %s", TEST_STR, obj.RawString())
		}
	...
	t.Run("reads data correctly from hashed object", func(t *testing.T) {
		...
		obj, err := object.FromSHA(objSha, fs)
